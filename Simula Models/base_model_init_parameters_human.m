function [parameters, varargout] = base_model_init_parameters_human()
% % Default parameter values for the human base model from:
  ...
  % --- I_Na ---
  parameters(1) = 5.04; % g_Na;
  parameters(2) = 1; % lambda_Na;

  % --- I_NaL ---
  parameters(3) = 0.025; % g_NaL;
  ...
  parameters(8) = 1.8; % g_NaK;

  % --- I_Ks ---
  parameters(9) = 1; % epi;
  parameters(10) = 0.003; % g_Ks;
  parameters(11) = 0.018; % pNaK;

  % --- I_Kr ---
  parameters(12) = 0.025; % L0;
  parameters(13) = 2.3; % Q;
  parameters(14) = 0.0325; % g_Kr;
  parameters(15) = 1; % lambda_K;

  % --- I_to ---
  parameters(16) = 0.54; % g_to;

  % --- I_K1 ---
  parameters(17) = 0.074; % g_K1;

  % --- I_bCl ---
  parameters(18) = 0.0056; % g_bCl;

  % --- I_CaL ---
  parameters(19) = 1.8; % Q10CaL;
  parameters(20) = 0.168; % g_CaL;
  ...
  parameters(32) = 0.068; % g_pCa;

  % --- I_bCa ---
  parameters(33) = 0.00055; % g_bCa;
