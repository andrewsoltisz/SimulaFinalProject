function [parameters, varargout] = base_model_init_parameters_zebrafish()
  % % Default parameter values for the zebrafish base model from:
  ...
  % --- I_Na ---
  parameters(1) = 2.19586559070645; % g_Na;
  parameters(2) = 1; % lambda_Na;

  % --- I_NaL ---
  parameters(3) = 0.02760209975265; % g_NaL;
  ...
  parameters(8) = 9.23391257653548; % g_NaK;

  % --- I_Ks ---
  parameters(9) = 1; % epi;
  parameters(10) = 0.00240217802503; % g_Ks;
  parameters(11) = 0.018; % pNaK;

  % --- I_Kr ---
  parameters(12) = 0.11737554202720; % g_CaT;
  parameters(13) = 2.3; % Q;
  parameters(14) = 0.04384476100774; % g_Kr;
  parameters(15) = 1; % lambda_K;

  % --- I_to ---
  parameters(16) = 0.00353128881652; % g_to;

  % --- I_K1 ---
  parameters(17) = 0.85953073131003; % g_K1;

  % --- I_bCl ---
  parameters(18) = 0.00086686502904; % g_bCl;

  % --- I_CaL ---
  parameters(19) = 1.8; % Q10CaL;
  parameters(20) = 0.08591287886348; % g_CaL;
  ...
  parameters(27) = 4.17582468447562; % g_NaCa;
  ...
  parameters(32) = 0.05554428259050; % g_pCa;

  % --- I_bCa ---
  parameters(33) = 0.00190069502825; % g_bCa;

  % --- I_f ---
  parameters(34) = -17; % E_f;
  parameters(35) = 0.15; % g_f;
